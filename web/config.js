...
export function loadConfig(env = process.env) {
    ...
    return {
        ...
        sessionSecret: env.SESSION_SECRET ? env.SESSION_SECRET.trim() : (isVercel ? null : DEV_SESSION_SECRET),
        vercelClientId: env.VERCEL_APP_CLIENT_ID ? env.VERCEL_APP_CLIENT_ID.trim() : null,
        vercelClientSecret: env.VERCEL_APP_CLIENT_SECRET ? env.VERCEL_APP_CLIENT_SECRET.trim() : null,
        openrouterApiKey: env.OPENROUTER_API_KEY ? env.OPENROUTER_API_KEY.trim() : null,
        llmBackend: env.LLM_BACKEND || null,
        mockLlm: env.MOCK_LLM === '1',
        appUrl: env.APP_URL ? env.APP_URL.trim() : null,
